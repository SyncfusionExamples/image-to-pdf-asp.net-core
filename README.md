...
The [Syncfusion&reg; .NET PDF library](https://www.syncfusion.com/document-processing/pdf-framework/net) has extended support to convert images to PDF document in ASP.NET Core platform. This repository contains the examples to convert images (jpg, png, and tiff) into PDF document using C#. 
